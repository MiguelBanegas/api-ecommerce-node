 ...
 * 2. Ejecuta: node test_email.js tu-email@ejemplo.com
 */
...
if (!emailDestino) {
  ...
  console.log("\nUso: node test_email.js tu-email@ejemplo.com");
  process.exit(1);
}
...
req.on("error", (error) => {
  ...
  console.log("   3. La variable RESEND_API_KEY esté configurada");
});
